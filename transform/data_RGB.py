...
def get_training_data(rgb_dir, img_options, cutoff_freq=20):
    assert os.path.exists(rgb_dir)
    return DataLoaderTrain(rgb_dir, img_options, cutoff_freq)
...
def get_validation_data2(rgb_dir, img_options, cutoff_freq=20):
    assert os.path.exists(rgb_dir)
    return DataLoaderVal_(rgb_dir, img_options, cutoff_freq)
